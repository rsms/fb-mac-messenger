 (function () {
 	...
 	window.MacMessenger = {
 		...
 		showSettings: function () {
 			if (this.openGearMenu()) {
 				document.querySelector('a[data-reactid=".2h.0.0.0"]').dispatchEvent(
 					new MouseEvent('click', {
 						view: window,
 						bubbles: true,
 						cancelable: true
 	...
 	setInterval(function () {
 		MacMessenger.augmentConversation(document);
 	}, 2000);
 	...
 	var onDocumentLoaded = function () {
 		...
 		var tryFindSettingsGear = function () {
 			var e = document.querySelector('div[data-reactid^=".0.1.$0.0.0.$0.0.0"]');
 			if (e) {
 				e = e.parentNode;
