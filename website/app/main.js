// Let's not pollute the global namespace, shall we?
(function () {
  // Note:
  ...
  function onDocumentLoaded() {
    if (didAlreadyLoad || !(document.readyState === "complete" || document.readyState === "loaded" || document.readyState === "interactive")) {
      return;
    }
    didAlreadyLoad = true;
